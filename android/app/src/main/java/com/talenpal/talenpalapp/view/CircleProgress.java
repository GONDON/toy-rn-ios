...
import com.talenpal.talenpalapp.util.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {Color.parseColor("#ff1EAAFD"), Color.parseColor("#ff1EAAFD"), Color.parseColor("#ff1EAAFD")};
    //当前进度，[0.0f,1.0f]
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mSuffix = typedArray.getString(R.styleable.CircleProgressBar_suffix);
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(String.format(mPrecisionFormat, mValue) + mSuffix, mCenterPoint.x, mValueOffset, mValuePaint);
