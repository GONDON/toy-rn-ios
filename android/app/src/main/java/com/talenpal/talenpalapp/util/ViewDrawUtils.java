...
import com.talenpal.talenpalapp.listener.OnViewTreeObserver;
...
public class ViewDrawUtils {
    ...
    //根据宽设置高
    public static void viewScreenWidthSetHeight(final View view, final int screenWidth, final double scale) {
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            @Override
            public boolean onPreDraw() {
                view.getViewTreeObserver().removeOnPreDrawListener(this);
                int sjHeight = (int) (screenWidth / scale);
                Log.e("viewHeight", "viewHeight:" + sjHeight +"==scale:"+scale);
                ViewGroup.LayoutParams viewParams = view.getLayoutParams();
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                if (viewheight > height) {
                    ViewGroup.LayoutParams viewParams = view.getLayoutParams();
                    viewParams.height = DensityUtil.dip2px(height);
                    view.setLayoutParams(viewParams);
                }
                return true;
            }
