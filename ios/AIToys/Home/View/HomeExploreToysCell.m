...
- (void)awakeFromNib {
    [super awakeFromNib];
    [self.playBtn setTitle:LocalString(@"试玩一下") forState:0];
...
-(void)setModel:(HomeDollModel *)model{
    ...
    self.introduceLabel.text = model.dollModel.desc;
    [self.bgImgView sd_setImageWithURL:[NSURL URLWithString:model.dollModel.backgroundImg] placeholderImage:[UIImage imageNamed:@"home_explore_toys_bg.png"]];
