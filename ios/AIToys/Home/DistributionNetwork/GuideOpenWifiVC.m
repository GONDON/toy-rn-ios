...
@interface GuideOpenWifiVC ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;

@end

@implementation GuideOpenWifiVC
...
- (void)viewDidLoad {
    ...
    [closeBtn setImage:[UIImage imageNamed:@"icon_close"] forState:0];
