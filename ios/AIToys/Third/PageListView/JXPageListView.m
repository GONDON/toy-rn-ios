...
- (void)initializeViews {
    ...
    self.pinCategoryView = [[JXCategoryTitleImageView alloc] initWithFrame:CGRectZero];
    self.pinCategoryView.backgroundColor = UIColorHex(F6F7FB);
...
//    self.pinCategoryView.indicators = @[lineView];
    ...
    _mainTableView = [[JXPageListMainTableView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
...
- (CGFloat)listContainerCellHeight {
    return self.bounds.size.height - self.pinCategoryViewVerticalOffset - 30;
}
