...
/* 设置加粗字体的大小 **/
#define FontBoldThin(size)  [UIFont boldSystemFontOfSize:size]
...
#define strongTextColor    UIColorHex(414564)
#define generalTextColor   UIColorHex(666666)
#define lightTextColor     UIColorHex(B3B3B3)
