...
- (void)setUI{
    ...
    [self.pushButton setTitle:[NSString stringWithFormat:@"跳过(%d)s",secondCount] forState:UIControlStateNormal];
    self.pushButton.titleLabel.font = [UIFont systemFontOfSize:14];
...
- (void)changeSecond{
    if (_times<=0) {
        ...
        _times --;
        [self.pushButton setTitle:[NSString stringWithFormat:@"跳过(%ld)s",(long)_times] forState:UIControlStateNormal];
    }
}
